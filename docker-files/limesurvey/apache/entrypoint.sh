...
wget -cqO - https://code.jquery.com/jquery-3.4.1.js > third_party/jquery/jquery-3.1.1.js
wget -cqO - https://code.jquery.com/jquery-3.4.1.min.js > third_party/jquery/jquery-3.1.1.min.js
exec "$@"
